...
{
   Cross-platform OpenGL implementation for Delphi XE2/XE5/Berlin

   (c)2014-2016 Execute SARL  <contact@execute.fr>
...
constructor TGLWindow.Create(AContext: TGLContext);
begin
  FContext := AContext;
  inherited Create(FContext.FWidth, FContext.FHeight);
end;

procedure TGLWindow.SetupGL;
begin
  FContext.CreateContext;
end;

procedure TGLWindow.OnResize;
begin
  FContext.SetSize(Width, Height);
end;

procedure TGLWindow.OnIdle;
begin
  FContext.Repaint;
end;

procedure TGLWindow.OnPaint;
begin
  FContext.Repaint;
end;
{$ENDIF}
